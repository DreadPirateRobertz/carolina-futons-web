...
**YOU ARE IN: `cfutons_web/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cfutons_web/` (rig root) or other directories
...
**Your mail address:** `cfutons_web/polecats/obsidian`
**Your rig:** cfutons_web
**Your Witness:** `cfutons_web/witness`
...
| Ask Witness for help | `gt mail send cfutons_web/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cfutons_web/witness`) when:
...
```bash
gt mail send cfutons_web/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
