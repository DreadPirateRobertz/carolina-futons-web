...
export const FIXTURE_COLLECTIONS = [
  { _id: "fixture-col-all",           slug: "all-products",        name: "All Products",          numberOfProducts: 5 },
  { _id: "fixture-col-futon-frames",  slug: "futon-frames",        name: "Futon Frames",          numberOfProducts: 2 },
  { _id: "fixture-col-murphy-beds",   slug: "murphy-cabinet-beds", name: "Murphy Cabinet Beds",   numberOfProducts: 1 },
