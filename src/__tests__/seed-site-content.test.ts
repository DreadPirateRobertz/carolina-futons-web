...
describe("seed-site-content SEED_ROWS", () => {
  ...
  it("contains exactly 75 rows (29 §1 live + 24 §2 proposed + 3 cfw-dag registry + 13 cfw-p3j sustainability + 3 cfw-udr videos + 3 social)", () => {
    expect(SEED_ROWS).toHaveLength(75);
  });
