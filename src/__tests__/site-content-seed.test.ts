...
describe("provision-site-content seed-data.json", () => {
  ...
  it("contains exactly 77 seed rows (cfw-roi + cfw-34q value-props + cfw-66o.4 shop copy + cfw-66o.11 about copy + cfw-66o.5 featured-row + cfw-66o.3 descriptions + cfw-mr7 guides index + cfw-dag registry + cfw-p3j sustainability + cfw-z6n swatch)", () => {
    const seed = loadSeed();
    expect(seed.rows).toHaveLength(77);
  });
  ...
  it("includes the keys the cfw-66o specs already wired with getSiteContent fallbacks", () => {
    ...
    const REQUIRED_KEYS = [
      ...
      // cfw-66o.5: futon-frames featured-row editorial copy
      "shop.futon-frames.featured.eyebrow",
      "shop.futon-frames.featured.heading",
      "shop.futon-frames.featured.body",
      // cfw-66o.3: PLP category descriptions wired to getSiteContent
      "shop.futon-frames.description",
      "shop.murphy-cabinet-beds.description",
      "shop.platform-beds.description",
      "shop.mattresses.description",
      "shop.sofa-beds.description",
      "shop.sale.description",
      "shop.mattresses-sale.description",
      // cfw-mr7: guides index page copy (eyebrow, heading, subhead)
