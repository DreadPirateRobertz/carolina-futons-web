...
export function MegaMenuItem({ label, href }: MegaMenuItemProps) {
  ...
  if (!panel) {
    ...
    return (
      <Link
        href={href}
        className="text-sm font-medium text-cf-cream transition-colors hover:text-[#F5C97A] focus-visible:outline-none focus-visible:text-[#F5C97A]"
      >
        {label}
      </Link>
    );
  ...
  return (
    ...
    >
      <button
        ...
        className="inline-flex items-center gap-1 text-sm font-medium text-cf-cream transition-colors hover:text-[#F5C97A] focus-visible:outline-none focus-visible:text-[#F5C97A]"
      >
        {label}
        <svg
          aria-hidden="true"
