...
export function ConsentBanner({ initialChoice }: ConsentBannerProps) {
  ...
  return (
    <aside
      ...
      className="fixed inset-x-2 bottom-2 z-50 mx-auto max-w-3xl rounded-lg border border-cf-divider bg-white dark:bg-cf-cream p-4 shadow-lg sm:inset-x-auto sm:right-4 sm:left-auto sm:w-[28rem]"
    >
