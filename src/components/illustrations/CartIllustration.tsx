...
// standard palette + a futon silhouette in cf-cta orange on the near
// ridge. Decorative — aria-hidden; the drawer's own heading carries meaning.
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#1E3A5F"
      />
      {/* Futon silhouette on the near ridge horizon — cf-cta orange */}
