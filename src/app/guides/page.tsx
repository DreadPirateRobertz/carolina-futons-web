            ...
            <li key={guide.slug}>
              <HeroReveal delay={index * CARD_STAGGER_SECONDS}>
                <Link
                  ...
                  className="group flex h-full flex-col gap-3 rounded-lg border border-cf-ink/10 bg-white p-6 transition hover:border-cf-cta/40 hover:shadow-sm dark:bg-cf-cream"
                >
                  <div
                    aria-hidden="true"
