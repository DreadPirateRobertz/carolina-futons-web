...
//
// Logs via logError inside useEffect so the existing Sentry capture
// still picks up the digest. The error.digest is surfaced in the UI
...
export default function AdminError({
  ...
  useEffect(() => {
    logError("admin-error-boundary", "admin page render threw", error);
  }, [error]);
